Always follow the instructions in PLAN.md. When I say "lets implement", find the next unmarked test in plan.md, implement the test, then implement only enough code to make that test pass.
